...
// BBP-Type Formula
template <class T, T length, T width, class P> constexpr double Cake<T, length, width, P>::get_ln2(){
...
template <class T, T length, T width, class P> double Cake<T, length, width, P>::getArea(){
